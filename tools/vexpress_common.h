...
#if 1
#define CONFIG_BOOTCOMMAND "ext2load mmc 0 0x60003000 linux/arch/arm/boot/uImage;ext2load mmc 0 0x60500000 linux/arch/arm/boot/dts/vexpress-v2p-ca9.dtb;bootm 0x60003000 - 0x60500000"
#else
#define CONFIG_BOOTCOMMAND	"tftp 0x60003000 linux/arch/arm/boot/uImage;tftp 0x60500000 linux/arch/arm/boot/dts/vexpress-v2p-ca9.dtb;bootm 0x60003000 - 0x60500000"
#endif
/*
